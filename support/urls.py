...
urlpatterns =[
    ...
    url(r'^customer_chat_post_message/$', views.customer_chat_post_message, name='customer_chat_post_message'),
    ...
    url(r'^admin_chat_post_message/$', views.admin_chat_post_message, name='admin_chat_post_message'),
