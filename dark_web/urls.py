...
urlpatterns = [
    ...
    url(r'^vendor/shipping_options/$', vendor_views.VendorShippingOptions, name='user_VendorShippingOptions'),
    url(r'^vendor/add_shipping/$', vendor_views.edit_shipping_options, name='edit_shipping_options'),
